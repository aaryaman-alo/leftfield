    ...
    <div className="py-16 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="space-y-8 max-w-6xl">
          <p className="text-xl">
            By helping clients identify and successfully engage with enterprises in the public and private sectors, the team at Leftfield has delivered $750 Million in contracts over the past decade.
          </p>
          
          <p className="text-xl">
            Leftfield specializes in helping companies to expand their business development and revenue generation activities in some of the largest economic areas in the world: the United States, the European Union, and India.
          </p>
